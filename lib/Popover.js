...
var styles = react_native_1.StyleSheet.create({
    container: __assign(__assign({}, react_native_1.StyleSheet.absoluteFillObject), { opacity: 0, backgroundColor: 'transparent' }),
    containerVisible: {
        opacity: 1,
    },
    background: __assign(__assign({}, react_native_1.StyleSheet.absoluteFillObject), { backgroundColor: 'rgba(0,0,0,0.5)' }),
    popover: __assign(__assign({}, react_native_1.Platform.select({
        ios: {
            shadowColor: 'black',
    ...
    function Popover(props) {
        ...
        _this.measureContent = function (_a) {
            ...
            if (width && height) {
                ...
                _this.updateState(__assign(__assign({}, geom), { contentSize: contentSize }), function () {
                    if (isAwaitingShow_1) {
